...
$$ These calculations are occurring at equilibrium, so that means we can set this to zero. We know that this is a modification of the assimilation rate $\hat{a}_i$ that will also make this zero. We make this a constant change across all assimilation rates.
