...
$$
A = \begin{pmatrix}
a_{1}p_{1} - \frac{w_{11}X_1}{\sum_{h=1}^N{w_{1h}X_h}} & ... & - \frac{w_{N1}X_1}{\sum_{h=1}^N{w_{Nh}X_h}} \\
\vdots &  & \vdots \\
- \frac{w_{1N}X_N}{\sum_{h=1}^N{w_{1h}X_h}} & ... & a_{N}p_{N} - \frac{w_{NN}X_N}{\sum_{h=1}^N{w_{Nh}X_h}} \\
\end{pmatrix}
$$
...
$$
\hat{A} = \begin{pmatrix}
a_{1}p_{1} - \frac{w_{11}X_1}{\sum_{h=1}^N{w_{1h}X_h}} & ... & - \frac{w_{N1}X_1}{\sum_{h=1}^N{w_{Nh}X_h}} & ... & 0 \\
\vdots &  & \vdots  & - X_m & 0 \\
\vdots &  & \vdots  & \vdots & \vdots \\
\vdots &  & \vdots  & 0 & - X_M \\
- \frac{w_{1N}X_N}{\sum_{h=1}^N{w_{1h}X_h}} & ... & a_{N}p_{N} - \frac{w_{NN}X_N}{\sum_{h=1}^N{w_{Nh}X_h}} & ... & 0 \\
